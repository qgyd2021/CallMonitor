...
# nohup sh for_restart.sh --environment hk --http_port 4071 --build_dir build > nohup.out &
# nohup sh for_restart.sh --environment mx --http_port 4071 --build_dir build > nohup.out &
